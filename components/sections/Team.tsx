...
const teamMembers = [
  {
    ...
    role: "Founder",
    qualifications:
      "B.Sc, Diploma in Finance & Accounting (Germany), DCA, Diploma in Tech",
    exp: "9+ Years",
  ...
  {
    name: "Jasmeet Kaur",
    role: "Business Associate Partner",
    qualifications: "BBA",
    exp: "5+ Years",
    desc: "Provides seamless, high-value results by navigating complex financing landscapes and focusing on customized finance solutions.",
  },
];
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="space-y-2 mb-4 text-sm text-slate-500 dark:text-slate-400">
                <p>
                  <strong>Edu:</strong> {member.qualifications}
                </p>
                <p>
                  <strong>Exp:</strong> {member.exp}
                </p>
              </div>
